...
| # | Part | 章數 | 主題 |
|---|------|------|------|
| 0 | [後端與網路/OS 基礎 Backend Foundations](00-backend-foundations/) | 10 | 前置通識：一個請求的完整旅程、TCP/TLS、Linux/OS 與訊號——本書其餘部分「用而不教」的底層（撰寫中）。 |
...
| 16 | [架構與設計 Architecture](16-architecture/) | 13 | 分層、Clean Architecture、DI、Repository、SOLID 與設計模式。 |
...
| 21 | [微服務 Microservices](21-microservices/) | 11 | gRPC、服務發現、API gateway、限流與熔斷——Python 的微服務實務。 |
