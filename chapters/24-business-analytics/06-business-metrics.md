...
前面幾章是**統計工具**,這章教你把工具算出的數字,翻成**老闆聽得懂、能拍板的商業語言**。
三個框架撐起大半的產品/成長分析:

**1. 漏斗(funnel)——找出「客人在哪一步跑掉」。**
造訪 → 註冊 → 加購物車 → 下單 → 付款,每一步都漏人。
算出**每一步的轉換率**,揪出**最大流失點**——
「80% 的人加了購物車卻沒付款」,那就是投資報酬率最高的優化目標。
別平均用力,**盯最大的那個洞補**。

**2. 留存(retention)——「新客留得住嗎」。**
拉新很貴,留存才是複利。看**第 N 天還有多少人回來**,
畫成留存曲線:健康的產品曲線會**趨於平緩**(留下死忠用戶);
一路滑到 0 ＝產品留不住人,再多拉新都是漏水的桶。
**同群分析(cohort)** 是主力工具:把「一月註冊的人」和「二月註冊的人」分開追蹤,
才看得出改版有沒有真的改善留存。

**3. 單位經濟(unit economics)——「這門生意划算嗎」。**
**LTV(顧客終身價值)vs CAC(獲客成本)**:一個客人一輩子貢獻的錢,
有沒有超過你當初花在把他拉來的錢?**LTV / CAC > 3** 是常見的健康線;
小於 1 ＝每拉一個客人就虧一次,規模越大死越快。

這章用 pandas 把三個框架各實作一遍(漏斗轉換、cohort 留存表、LTV/CAC 試算),
讓你算得出、也講得出這些讓決策層買單的數字。
